...
#sys.path.remove('/usr/local/lib/python3.6/dist-packages')  #for local purposes
#sys.path.remove('/usr/lib/python3/dist-packages')  #for local purposes
#sys.path.remove('/home/erich/.local/lib/python3.6/site-packages')  #for local purposes

import numpy as np, pandas as pd, imageio
import random, time #new
from imgaug import augmenters as iaa
# Root directory to the Mask_RCNN Folder:
Mask_RCNN_DIR = 'C:/Users/Erich/Desktop/Segmenter/'
